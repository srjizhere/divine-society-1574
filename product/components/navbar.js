        ...
        <div class="modal-header">
          ...
          <div class="modal-body">
                ...
                <div class="modal-right">
                    <div class="form_div">
                        <h3 style="text-align: center; margin-bottom: 15px;">Create an Acoount</h3>
                        <form action="" id="login_form">
                            <input type="email" placeholder="Email" id="email">
                            <input type="text" placeholder="Password" id="password">
                            <p><input type="checkbox"> <span>Subscribe to personalized sale updates and offers</span></p>
                        </form>
                    ...
                    <p class="already">Alredy have an account?Please SignIn</p>
                </div>
            </div>
        </div>
      <div id="moverlay"></div>
